...
public class CalendarApplication extends Application {
	...
	/**
	 * Denne funksjonen lager ett nytt vindu, med FXMLen som befinner seg på
	 * stien `path`. Kontrolleren som funksjonen returnerer er kontrolleren som
	 * styrer vinduet. Denne har tilgang på den nye Stagen.
	 * 
	 * @param path
	 *            Stien til FXMLen
